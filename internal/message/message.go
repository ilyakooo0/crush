...
type Service interface {
	...
	ListAfter(ctx context.Context, sessionID, afterMessageID string) ([]Message, error)
...
func (s *service) ListAfter(ctx context.Context, sessionID, afterMessageID string) ([]Message, error) {
